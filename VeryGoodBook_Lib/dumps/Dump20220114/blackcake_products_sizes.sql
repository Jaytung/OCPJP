...
CREATE TABLE `products_sizes` (
  ...
  CONSTRAINT `fkey_products_sizes_TO_product` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`)
...
INSERT INTO `products_sizes` VALUES (5,'大盒','imgs/slide1.png','imgs/slide1.png',26,200),(5,'小盒','imgs/blackcake.jpg','imgs/blackcake.jpg',24,100),(7,'大','黑糖糕.png','黑糖糕.png',20,200),(7,'小','黑糖糕.png','黑糖糕.png',15,100);
