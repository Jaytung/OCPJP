				...
				<div class="registerForm">
					<form method="post" action="register.do"
						...
						<div class="form-row firstForm justify-content-center">
							...
							<div class="form-group col-md-4">
								<label for="password">密碼Password</label> <input type="password"
						...
						<div class="form-row justify-content-center">
							...
							<div class="form-group col-md-4">
								<label for="phone">電話</label> <input type="tel"
									class="form-control shadow" id="phone" placeholder="輸入您的電話"
									name="phone" required>
							</div>
						</div>
						<div class="form-row justify-content-center">
						...
						<div class="custom-control custom-checkbox form-group row">
							<div class="form-check" id="subscribed">
								<input class="custom-control-input" type="checkbox"
									...
									class="custom-control-label" for="isSubscribed">訂閱電子報</label>
							</div>
						</div>
