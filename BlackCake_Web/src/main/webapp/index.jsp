...
<body>
	...
	<div class="container-fulid px-0 mt-0 titleSlide">
	...
	<section class="container-fulid px-0 mt-0">
		<div class="row align-items-center">
			...
			<div class="col-lg-6 photo rounded border-top">
				<div id="carousel" class="carousel slide" data-ride="carousel">
					...
					<button class="carousel-control-prev bg-dark col-1 rounded"
						type="button" data-target="#carousel" data-slide="prev">

						<span class="carousel-control-prev-icon" aria-hidden="true"></span>
						<span class="sr-only">Previous</span>
					</button>
					<button class="carousel-control-next bg-dark col-1  rounded"
						type="button" data-target="#carousel" data-slide="next">
		...
		<div class="row align-items-center content mt-0 mb-0"  id="squid">
			<div class="col-md-6 text-center">
				<div class="row justify-content-center">
					<div class="col-10 mb-5 mb-md-0 partOne">
						<h2>小管片</h2>
						<img src="imgs/squidlogo.png" alt=""
							class="d-none d-lg-inline px-4 ">
						<p class="lead">
