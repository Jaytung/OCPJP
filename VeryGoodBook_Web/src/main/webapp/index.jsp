		...
		<div class="carousel slide carousel-fade" data-ride="carousel">
			<div class="carousel-inner">
				<div class="carousel-item active" data-interval="4000">
					<img src="imgs/綜合.png" class="d-block w-100">
				</div>
				<div class="carousel-item" data-interval="3000">
					<img src="imgs/標題.png" class="d-block w-100">
				</div>
			</div>
		</div>
		<section class="container-fulid px-0 mt-0 border-top">
			<div class="row align-items-center">
				...
				<div class="col-lg-6 photo rounded border-top">
					<div id="carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="carousel-item active" data-interval="4000">
								<a href="#blackCake"> <img src="imgs/slide1.png" class="d-block w-100" alt="黑糖糕"></a>
							</div>
							<div class="carousel-item" data-interval="5000">
								<a href="#小管片"> <img src="imgs/slide2.png" class="d-block w-100" alt="小館片"></a>
							</div>
							<div class="carousel-item" data-interval="5000">
								<a href="#XO醬"> <img src="imgs/slide3.png" class="d-block w-100" alt="XO醬"></a>
							</div>
						</div>
			...
			<div class="row align-items-center content mt-0 mb-0">
				<div class="col-md-6 text-center">
					<div class="row justify-content-center">
						<div class="col-10 mb-5 mb-md-0 partOne">
							<h2>小管片</h2>
							<img src="imgs/squidlogo.png" alt="" class="d-none d-lg-inline px-4 ">
							<p class="lead">
								澎湖七美小管片採用當地澎湖現撈小管製成每一片皆由一隻小管，經手工處理、曬乾、烘烤而成製作過程繁瑣但原料使用簡單，保留小管最原有的嚼勁與甜味是最道地最澎湖味的名產，澎湖人最愛！
							</p>
						</div>
					</div>
				</div>
			...
			<div class="row align-items-center content mt-0">
				...
				<div class="col-md-6 text-center order-1 order-md-2">
					<div class="row justify-content-center">
						<div class="col-10 mb-5 mb-md-0 partOne">
							<h2>海鮮XO醬</h2>
							<img src="imgs/jarlogo.png" alt="" class="d-none d-lg-inline">
